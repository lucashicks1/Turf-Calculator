...
<body class="text-white bg-dark">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="cart.php">CART - <i class="fas fa-shopping-cart"></i>
                            ...
                            if ($_SESSION["totals"][5] == 1) {
                                ...
                                printf("1 ITEM - $%s", $_SESSION["totals"][0]);
                            } else {
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12 text-center">
                    <h1 style="font-size:3.5rem;">TURFS UP</h1>
                </div>
    ...
    <section class="py-5">
        <div class="container text-center">
            ...
            <h3 class="font-weight-light" id="main">WELCOME TO TURFS UP</h3>
            <p>Turfs Up has been growing, delivering and installing the highest quality lawns since 1988. This once small family business has now expanded into further locations and boasts specialised turf varieties suitable for all across Australia. The company's supply of premium products has positioned it at the forefront of Queensland's turf market.</p>
        </div>
    </section>
        ...
        <div class="row my-5">
            <div class="col-12 col-md-6 my-4">
                <div class="thumbnail text-center">
                    <a href="products.php">
                        <img src="images/products.jpg" alt="" class="img-fluid rounded">
                        <div class="caption">
                            <h3>PRODUCTS</h3>
                        </div>
                    </a>
            ...
            <div class="col-12 col-md-6 my-4">
                <div class="thumbnail text-center">
                    <a href="cart.php">
                        <img src="images/cart.jpg" alt="" class="img-fluid rounded">
                        <div class="caption">
                            <h3>CART</h3>
                        </div>
                    </a>
            ...
            <div class="col-12 col-md-6 my-4">
                <div class="thumbnail text-center">
                    <a href="calculator.php">
                        <img src="images/calculator.jpg" alt="" class="img-fluid rounded">
                        <div class="caption">
                            <h3>CALCULATOR</h3>
                        </div>
                    </a>
