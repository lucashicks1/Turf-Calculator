...
<head>
    ...
    <meta name="Description" content="This page contains information about Kikuyu Grass.">
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css" />
    <link rel="stylesheet" type="text/css" href="../main.css">
    <title>Turfs Up - Kikuyu Grass</title>
    ...
    <div class="my-4 mx-5">
        <div class="row">
            <div class="col-12 col-lg-4 offset-lg-4">
                <h2 class="text-center">Kikuyu Grass</h2>
                <hr />
            </div>
        </div>
    </div>
    ...
    <div class="col-10 offset-1 col-xl-8 offset-xl-2">
        <div class="row">
            <div class="col-12 col-md-4">
                    <img src="../Images/Grass/kikuyugrass.jpg" class="rounded img-fluid m-2" width="250px" alt="Kikuyu Grass image"/>
                    <p class="lead">Kikuyu Grass</p>
                </div>
            <div class="col-12 col-md-6 offset-md-2">
                <p class="mt-5">
                    Kikuyu turf is one of the hardiest, best looking, cost-effective grasses on the market. Homeowners choose Kikuyu grass due to its high drought tolerance, excellent wear resistance and ability to maintain good winter colour. During winter, Kikuyu grass continues to grow when other warm-season turf types stop. In terms of soil, Kikuyu lawns are best suited to loams, sandy loams and loamy sand soils.
                </p>
                <div class="row">
                    <div class="col-6">
                        <h5 class="align-bottom mt-3">Cost: 10/m<sup>2</sup></h5>
                    </div>
                    <div class="col-6">
