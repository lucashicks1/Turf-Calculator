...
<head>
    ...
    <meta name="Description" content="This page contains information about Buffalo Grass.">
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css" />
    <link rel="stylesheet" type="text/css" href="../main.css">
    <title>Turfs Up - Buffalo Grass</title>
    ...
    <div class="my-4 mx-5">
        <div class="row">
            <div class="col-12 col-lg-4 offset-lg-4">
                <h2 class="text-center">Buffalo Grass</h2>
                <hr />
            </div>
        </div>
    </div>
    ...
    <div class="col-10 offset-1 col-xl-8 offset-xl-2">
        <div class="row">
            <div class="col-12 col-md-4">
                    <img src="../Images/Grass/buffalograss.jpg" class="rounded img-fluid m-2" width="250px" alt="Buffalo Grass image"/>
                    <p class="lead">Buffalo Grass</p>
                </div>
            <div class="col-12 col-md-6 offset-md-2">
                <p class="mt-5">
                    Buffalo turf is one of the true stalwarts of all turf grasses because it looks luscious, soft and green, tolerates up to 70% shade, is low in maintenance and very water efficient. Soft Leaf Buffalo grasses are the most shade tolerant warm season lawn types in Australia due to their broad leaf which captures more sunlight. Buffalo grasses all respond and grow well in sandy, lightly salty, or alkaline soils and their thick growth habit means they out-compete weeds.


                </p>
                <div class="row">
                    <div class="col-6">
                        <h5 class="align-bottom mt-3">Cost: 16/m<sup>2</sup></h5>
                    </div>
                    <div class="col-6">
